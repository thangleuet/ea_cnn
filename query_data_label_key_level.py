    ...
    def caculate(self) -> None:
        ...
        for index, row in tqdm.tqdm(df_pd.iterrows()):
            if index > 5:
                ...
                if timestamp == '2024-07-09 15:00:00':
                    print(timestamp)
                ...
                if (
                    (-delta_threshold_1 < last_delta_support1 < delta_threshold_1 and last_delta_support1 > current_delta_support1 and status_min)
                ):
                ...
                if (
                    (delta_threshold_1 > last_delta_resistance1 > -delta_threshold_1 and last_delta_resistance1 < current_delta_resistance1 and status_max)
                ):
