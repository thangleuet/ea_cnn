    ...
    def caculate(self) -> None:
        ...
        for index, row in tqdm.tqdm(df_pd.iterrows()):
            ...
            if index > 5: 
                ...
                key_level = output_ta['key_level_v1']
                ...
                if (
                    0 < current_delta_resistance1 < delta_threshold_1 and status_max and rsi > 50
                ):
                ...
                if (
                    0 > current_delta_support1 > -delta_threshold_1 and status_min and rsi < 50
                ):
